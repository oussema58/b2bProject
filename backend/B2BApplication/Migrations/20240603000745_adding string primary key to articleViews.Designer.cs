...
namespace B2BApplication.Migrations
{
    ...
    [Migration("20240603000745_adding string primary key to articleViews")]
    partial class addingstringprimarykeytoarticleViews
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("B2BApplication.Models.ArticleViews", b =>
                {
                    b.Property<string>("idArt")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("idArt", "userId");

                    b.HasIndex("articleId");

                    b.HasIndex("userId");

                    b.ToTable("articlesViews");
                });
            ...
            modelBuilder.Entity("B2BApplication.Models.Commande", b =>
                {
                    ...
                    b.Property<decimal>("commandeRevenue")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("B2BApplication.Models.CommandeLigne", b =>
                {
                    ...
                    b.Property<decimal>("articleTauxTva")
                        .HasPrecision(18, 3)
                        .HasColumnType("decimal(18,3)");
                    ...
                    b.Property<decimal>("ligneRevenue")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("B2BApplication.Models.User", b =>
                {
                    b.HasOne("B2BApplication.Models.Article", null)
                        .WithMany("viewedBy")
                        .HasForeignKey("ArticleID");

                    b.HasOne("B2BApplication.Models.User", "blockedBy")
                        .WithMany()
